...
with col1:
    st.write("This is a new tool which will help you slice through the application reviewing process easily. Choose from the applications on the left and may the onbaording START!")
