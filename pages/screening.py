...
# Render page
def render_page(user, submission_id, screener_nr, completed, evaluation, application, questions, links):
    ...
    with st.form("Evaluation Form", border=False):
        st.subheader("STARTie Evaluation")
        ...
        quantitative = st.slider("Rank this candidate on a scale from 1 to 5", min_value=1, max_value=5, step=1, value=quantitative_int)
